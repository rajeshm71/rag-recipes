...
Root-cause fix for a test-isolation issue: evals/judges.py's disk cache
lives at a real, persistent filesystem path (outputs/.judge_cache/) by
default. Without isolation,
